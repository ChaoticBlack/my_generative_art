...
def setup():
    ...
    for row in range(numRows):
        for col in range(numCols):
            ...
            # scaledX = row*0.005
            # scaledY = col*0.005
            # n=50*map(noise(scaledX,scaledY),0,1,-1,1)
            # x = col * res
            # y = row * res
            # # print("HI")
            # sinn = sin(n)
...
def colorChoosing(xCurr,yCurr):
    ...
    # colorArr = [[50, 100, 100],[47, 100, 99],[209, 100, 62],[217, 100, 42],[212, 100, 53]]
    # colorArr = [[12, 68, 93],[214, 52, 50],[202, 30, 85],[182, 11, 99],[218, 37, 25]]
    # colorArr = [[165, 100, 50],[137, 71, 58],[81, 87, 73],[65, 100, 82],[60, 87, 94]]
    # colorArr = [[176, 100, 66],[176, 64, 84],[56, 87, 99],[47, 91, 96],[29, 100, 91]]
    # colorArr = [[209, 36, 100],[208, 26, 100],[338, 31, 100],[337, 22, 100],[278, 18, 86]]
    # colorArr = [[358, 65, 100],[44, 77, 100],[83, 81, 79],[203, 87, 77],[265, 48, 58]]
    # colorArr = [[300, 16, 100],[275, 22, 100],[255, 29, 100],[233, 28, 100],[221, 27, 100]]
    # colorArr = [[178, 96, 75],[178, 70, 80],[179, 52, 85],[184, 35, 94],[174, 23, 100]]
...
def draw():
    ...
    for i in range(numSteps):
        if checkProximity( xStart, yStart): 
            ...
            cIndex = int(xoff/res)
            rIndex = int(yoff/res)
            gridAngle = grid[cIndex][rIndex].heading()
